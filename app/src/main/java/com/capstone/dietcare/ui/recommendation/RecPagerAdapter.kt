...
class RecPagerAdapter(private val recItem : List<DataItem>): RecyclerView.Adapter<RecPagerAdapter.RecViewHolder>(){

    class RecViewHolder (private val binding: ItemRecommendationRecipeBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind (data : DataItem){
            ...
            binding.btnEat.setOnClickListener {
                ...
                val recIntent = Intent(itemView.context, Recommendation2Activity::class.java)
